(function($) {
    ...
    var imJs = {
        ...
        methods: function(e) {
            ...
            imJs.navItemActive(); // Added method to handle active class on nav items
        },
...
// Add smooth scrolling and active class to navbar links on scroll
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Function to add active class based on the current section in view
    function addActiveClassOnScroll() {
        // Get current scroll position
        const scrollPos = window.scrollY + window.innerHeight / 2; // middle of the viewport

        // Loop through each section and apply active class to corresponding nav link
        navLinks.forEach(link => {
    ...
    navLinks.forEach(link => {
        link.addEventListener("click", function (event) {
            event.preventDefault(); // Prevent default behavior of jumping to section
